...
impl EmitCtx {
    ...
    fn build_map_i64(&self) -> Function {
        let ma = MemArg {
            offset: 0,
            align: 2,
            memory_index: 0,
    ...
    fn build_filter_i64(&self) -> Function {
        let ma = MemArg {
            offset: 0,
            align: 2,
            memory_index: 0,
    ...
    fn build_fold_i64(&self) -> Function {
        let ma = MemArg {
            offset: 0,
            align: 2,
            memory_index: 0,
    ...
    fn build_map_f64(&self) -> Function {
        let ma = MemArg {
            offset: 0,
            align: 2,
            memory_index: 0,
    ...
    fn build_filter_f64(&self) -> Function {
        let ma = MemArg {
            offset: 0,
            align: 2,
            memory_index: 0,
    ...
    fn vec_elem_size(&self, vec_op: &Operand) -> u32 {
    ...
    fn is_vec_i64(&self, vec_op: &Operand) -> bool {
        if let Operand::Place(Place::Local(id)) = vec_op {
    ...
    fn is_vec_f64(&self, vec_op: &Operand) -> bool {
        if let Operand::Place(Place::Local(id)) = vec_op {
