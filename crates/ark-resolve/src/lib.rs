...
#[allow(deprecated)]
pub use resolve::{
    LoadedModule, ResolveCrateOptions, ResolvedEnum, ResolvedFunction, ResolvedModule,
    ResolvedProgram, ResolvedStruct, Visibility, analyze_loaded_program_with_options, bind_program,
    inject_wit_externs, load_program_graph_with_target, load_program_graph_with_target_and_parser,
    merge_prelude, resolve_module, resolve_module_default, resolve_module_for_tests,
