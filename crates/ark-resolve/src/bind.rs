...
pub(crate) fn inject_prelude_symbols(symbols: &mut SymbolTable, scope: ScopeId) {
    ...
    const PRELUDE_FUNCTIONS: &[&str] = &[
        ...
        "__intrinsic_get",
        "__intrinsic_set",
        "__intrinsic_get_unchecked",
        "__intrinsic_is_empty",
        "__intrinsic_is_ok",
        "__intrinsic_is_err",
        "__intrinsic_is_some",
        "__intrinsic_is_none",
        "__intrinsic_unwrap",
        "__intrinsic_unwrap_or",
        "__intrinsic_values",
        "__intrinsic_byte_at",
        "__intrinsic_byte_len",
        "__intrinsic_lines",
        "__intrinsic_repeat",
        "__intrinsic_pad_left",
        "__intrinsic_pad_right",
        "__intrinsic_trim_start",
        "__intrinsic_trim_end",
        "__intrinsic_gcd",
        "__intrinsic_pow_i32",
        "__intrinsic_i32_to_u32",
        "__intrinsic_f32_to_string",
        "__intrinsic_any_i64",
        "__intrinsic_any_f64",
        "__intrinsic_any_String",
        "__intrinsic_find_i64",
        "__intrinsic_find_f64",
        "__intrinsic_find_String",
        "__intrinsic_fold_f64_f64",
        "__intrinsic_range_new",
        "__intrinsic_range_len",
        "__intrinsic_range_contains",
        "HashMap_i32_i32_new",
        ...
        // Selfhost-compatible intrinsics: bare names used directly in selfhost source
        "eq",
        "clone",
        "String_from",
        "concat",
        ...
        "Vec_new_f64",
        "Vec_new_String",
        "Vec_new_i32_with_cap",
        "Vec_new_i64_with_cap",
        "Vec_new_f64_with_cap",
        "Vec_with_capacity_i32",
        "Vec_with_capacity_String",
        "Box_new",
        "unbox",
