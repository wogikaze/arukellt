...
impl TypeChecker {
    ...
    pub fn register_builtins(&mut self) {
        ...
        // --- HashMap<String, i32> ---
        self.fn_sigs.insert(
            "HashMap_new_String_i32".into(),
            FnSig {
                name: "HashMap_new_String_i32".into(),
                type_params: vec![],
                type_param_bounds: vec![],
                params: vec![],
                ret: Type::I32,
        ...
        self.fn_sigs.insert(
            "HashMap_String_i32_insert".into(),
            FnSig {
                name: "HashMap_String_i32_insert".into(),
                type_params: vec![],
                type_param_bounds: vec![],
                params: vec![Type::I32, Type::String, Type::I32],
                ret: Type::Unit,
            },
        );
        self.fn_sigs.insert(
            "HashMap_String_i32_get".into(),
            FnSig {
                name: "HashMap_String_i32_get".into(),
                type_params: vec![],
                type_param_bounds: vec![],
        ...
        self.fn_sigs.insert(
            "HashMap_String_i32_contains_key".into(),
            FnSig {
                name: "HashMap_String_i32_contains_key".into(),
                type_params: vec![],
                type_param_bounds: vec![],
                params: vec![Type::I32, Type::String],
                ret: Type::Bool,
        ...
        self.fn_sigs.insert(
            "HashMap_String_i32_len".into(),
            FnSig {
                name: "HashMap_String_i32_len".into(),
                type_params: vec![],
                type_param_bounds: vec![],
                params: vec![Type::I32],
                ret: Type::I32,
        ...
        // --- Additional intrinsics used by the selfhost compiler ---
        // Vec intrinsics (polymorphic, use Any for element type)
        self.fn_sigs.insert(
            "__intrinsic_len".into(),
            FnSig { name: "__intrinsic_len".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_push".into(),
            FnSig { name: "__intrinsic_push".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::Unit },
        );
        self.fn_sigs.insert(
            "__intrinsic_pop".into(),
            FnSig { name: "__intrinsic_pop".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_get".into(),
            FnSig { name: "__intrinsic_get".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::I32], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_set".into(),
            FnSig { name: "__intrinsic_set".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::I32, Type::Any], ret: Type::Unit },
        );
        self.fn_sigs.insert(
            "__intrinsic_get_unchecked".into(),
            FnSig { name: "__intrinsic_get_unchecked".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::I32], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_is_empty".into(),
            FnSig { name: "__intrinsic_is_empty".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Bool },
        );
        // Option/Result intrinsics
        self.fn_sigs.insert(
            "__intrinsic_is_ok".into(),
            FnSig { name: "__intrinsic_is_ok".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_is_err".into(),
            FnSig { name: "__intrinsic_is_err".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_is_some".into(),
            FnSig { name: "__intrinsic_is_some".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_is_none".into(),
            FnSig { name: "__intrinsic_is_none".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_unwrap".into(),
            FnSig { name: "__intrinsic_unwrap".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_unwrap_or".into(),
            FnSig { name: "__intrinsic_unwrap_or".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_values".into(),
            FnSig { name: "__intrinsic_values".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::Any },
        );
        // Byte intrinsics
        self.fn_sigs.insert(
            "__intrinsic_byte_at".into(),
            FnSig { name: "__intrinsic_byte_at".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::I32], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_byte_len".into(),
            FnSig { name: "__intrinsic_byte_len".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::I32 },
        );
        // String intrinsics
        self.fn_sigs.insert(
            "__intrinsic_lines".into(),
            FnSig { name: "__intrinsic_lines".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String], ret: Type::Vec(Box::new(Type::String)) },
        );
        self.fn_sigs.insert(
            "__intrinsic_repeat".into(),
            FnSig { name: "__intrinsic_repeat".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String, Type::I32], ret: Type::String },
        );
        self.fn_sigs.insert(
            "__intrinsic_pad_left".into(),
            FnSig { name: "__intrinsic_pad_left".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String, Type::I32], ret: Type::String },
        );
        self.fn_sigs.insert(
            "__intrinsic_pad_right".into(),
            FnSig { name: "__intrinsic_pad_right".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String, Type::I32], ret: Type::String },
        );
        self.fn_sigs.insert(
            "__intrinsic_trim_start".into(),
            FnSig { name: "__intrinsic_trim_start".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String], ret: Type::String },
        );
        self.fn_sigs.insert(
            "__intrinsic_trim_end".into(),
            FnSig { name: "__intrinsic_trim_end".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::String], ret: Type::String },
        );
        // Math intrinsics
        self.fn_sigs.insert(
            "__intrinsic_gcd".into(),
            FnSig { name: "__intrinsic_gcd".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::I32, Type::I32], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_pow_i32".into(),
            FnSig { name: "__intrinsic_pow_i32".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::I32, Type::I32], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_i32_to_u32".into(),
            FnSig { name: "__intrinsic_i32_to_u32".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::I32], ret: Type::U32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_f32_to_string".into(),
            FnSig { name: "__intrinsic_f32_to_string".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::F32], ret: Type::String },
        );
        // HOF intrinsics (i64/f64/String variants)
        self.fn_sigs.insert(
            "__intrinsic_any_i64".into(),
            FnSig { name: "__intrinsic_any_i64".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_any_f64".into(),
            FnSig { name: "__intrinsic_any_f64".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_any_String".into(),
            FnSig { name: "__intrinsic_any_String".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::Bool },
        );
        self.fn_sigs.insert(
            "__intrinsic_find_i64".into(),
            FnSig { name: "__intrinsic_find_i64".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_find_f64".into(),
            FnSig { name: "__intrinsic_find_f64".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_find_String".into(),
            FnSig { name: "__intrinsic_find_String".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::Any], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_fold_f64_f64".into(),
            FnSig { name: "__intrinsic_fold_f64_f64".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::F64, Type::Any], ret: Type::F64 },
        );
        // Range intrinsics
        self.fn_sigs.insert(
            "__intrinsic_range_new".into(),
            FnSig { name: "__intrinsic_range_new".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::I32, Type::I32], ret: Type::Any },
        );
        self.fn_sigs.insert(
            "__intrinsic_range_len".into(),
            FnSig { name: "__intrinsic_range_len".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any], ret: Type::I32 },
        );
        self.fn_sigs.insert(
            "__intrinsic_range_contains".into(),
            FnSig { name: "__intrinsic_range_contains".into(), type_params: vec![], type_param_bounds: vec![], params: vec![Type::Any, Type::I32], ret: Type::Bool },
        );
    }
}
