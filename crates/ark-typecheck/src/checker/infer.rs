...
impl TypeChecker {
    ...
    pub(crate) fn types_compatible(&self, a: &Type, b: &Type) -> bool {
        ...
        // Unresolved type variables are compatible with anything
        ...
        // Selfhost-compatible: allow i32/i64/char implicit conversion
        if matches!(a, Type::I32 | Type::I64 | Type::Char)
            && matches!(b, Type::I32 | Type::I64 | Type::Char)
        {
            return true;
        }
