...
impl TypeChecker {
    ...
    /// Check if a name is a known builtin function (selfhost-compatible).
    pub fn is_known_builtin(&self, name: &str) -> bool {
        const BUILTINS: &[&str] = &[
            "eq", "clone", "String_from", "concat", "to_string",
            "i32_to_string", "i64_to_string", "f64_to_string", "bool_to_string", "char_to_string",
            "parse_i32", "parse_i64", "parse_f64", "sqrt", "abs", "min", "max",
            "println", "print", "eprintln", "len", "push", "pop", "get", "get_unchecked",
            "set", "is_empty", "clear", "is_some", "is_none", "is_ok", "is_err",
            "unwrap", "unwrap_or", "unwrap_or_else", "expect", "ok", "err", "ok_or",
            "starts_with", "ends_with", "to_lower", "to_upper", "slice",
            "split", "join", "push_char", "read_line", "read_int", "trim",
            "contains", "index_of", "char_at", "substring", "replace",
            "fs_read_file", "fs_write_file", "fs_write_bytes",
            "clock_now", "clock_now_ms", "random_i32", "random_next_f64",
            "sort_i32", "sort_i64", "sort_f64", "sort_String",
            "map_i32_i32", "map_i64_i64", "map_f64_f64", "map_String_String",
            "filter_i32", "filter_i64", "filter_f64", "filter_String",
            "fold_i32_i32", "fold_i64_i64", "fold_f64_f64",
            "any_i32", "any_i64", "any_f64", "any_String",
            "find_i32", "find_i64", "find_f64", "find_String",
            "contains_i32", "contains_String",
            "reverse_i32", "reverse_String", "remove_i32",
            "assert", "assert_eq", "assert_ne", "assert_eq_i64", "assert_eq_str",
            "args", "arg_count", "arg_at", "env_var",
            "http_get", "http_request", "http_serve",
            "process_exit", "process_abort",
            "fd_seek", "fd_tell", "fd_fdstat_get",
            "memory_copy", "memory_fill",
            "f64_bits_lo", "f64_bits_hi",
            "byte_at", "byte_len", "lines", "repeat",
            "pad_left", "pad_right", "trim_start", "trim_end",
            "gcd", "pow_i32", "range_new", "range_len", "range_contains",
            ...
            "Box_new", "unbox",
            "map_option_String_String", "map_option_i32_i32", "map_result_i32_i32",
            "as_slice", "Some", "None", "Ok", "Err",
            "u8_to_i32", "u16_to_i32", "i8_to_i32", "i16_to_i32",
            "i32_to_u8", "i32_to_u16", "i32_to_i8", "i32_to_i16",
            "u32_to_u64", "u64_to_u32", "i32_to_i64", "i64_to_i32",
            "f32_to_f64", "f64_to_f32", "f32_to_string",
        ];
        BUILTINS.contains(&name) || name.starts_with("Vec_new_") || name.starts_with("HashMap_")
    }
