#!/usr/bin/env bash
# Component interop smoke test: f32 parameter and s32 result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/f32-param-i32/f32_param_i32.component.wasm"
SOURCE_REL="tests/component-interop/jco/f32-param-i32/f32_param_i32.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling f32_param_i32.ark -> component wasm"
...
echo "[2/3] Running f32 parameter invocation"
run_test "classify32(2.5) = 7" "7" "classify32(2.5)"
