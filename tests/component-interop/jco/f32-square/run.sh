#!/usr/bin/env bash
# Component interop smoke test: f32 parameter/result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/f32-square/f32_square.component.wasm"
SOURCE_REL="tests/component-interop/jco/f32-square/f32_square.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling f32_square.ark -> component wasm"
...
run_test "square32(2.5) = 2.5" "2.5" "square32(2.5)"
