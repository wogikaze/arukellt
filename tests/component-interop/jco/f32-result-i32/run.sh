#!/usr/bin/env bash
# Component interop smoke test: s32 parameter and f32 result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/f32-result-i32/f32_result_i32.component.wasm"
SOURCE_REL="tests/component-interop/jco/f32-result-i32/f32_result_i32.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling f32_result_i32.ark -> component wasm"
...
echo "[2/3] Running f32 result invocation"
run_test "half_count(10) = 0.5" "0.5" "half-count(10)"
