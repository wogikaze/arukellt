#!/usr/bin/env bash
# Component interop smoke test: String parameter to i32 result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/string-len/string_len.component.wasm"
SOURCE_REL="tests/component-interop/jco/string-len/string_len.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling string_len.ark -> component wasm"
...
run_test 'text_len("hello") = 5' "5" 'text-len("hello")'
run_test 'text_len("") = 0' "0" 'text-len("")'
