#!/usr/bin/env bash
# Component interop smoke test: renamed u8 scalar parameter/result.
...
COMPONENT_WASM="tests/component-interop/jco/u8-renamed/u8_renamed.component.wasm"
SOURCE_REL="tests/component-interop/jco/u8-renamed/u8_renamed.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling u8_renamed.ark -> component wasm"
...
echo "[2/3] Running renamed u8 invocations"
run_test "bump_byte(7) = 12" "12" "bump-byte(7)"
run_test "bump_byte(41) = 46" "46" "bump-byte(41)"
