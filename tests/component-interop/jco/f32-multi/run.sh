#!/usr/bin/env bash
# Component interop smoke test: general multi-export f32 canonical ABI.
...
echo "[3/4] Running f32 multi-export invocations"
run_test "square32(2.5) = 6.25" "6.25" "square32(2.5)"
run_test "add32(2.5, 3.25) = 5.75" "5.75" "add32(2.5, 3.25)"
