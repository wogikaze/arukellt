#!/usr/bin/env bash
# Component interop smoke test: String parameter to u16 result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/string-count16/string_count16.component.wasm"
SOURCE_REL="tests/component-interop/jco/string-count16/string_count16.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling string_count16.ark -> component wasm"
"$ARUKELLT" compile \
    --emit component \
...
run_test 'count16_text("") = 16' "16" 'count16-text("")'
run_test 'count16_text("hello") = 1600' "1600" 'count16-text("hello")'
