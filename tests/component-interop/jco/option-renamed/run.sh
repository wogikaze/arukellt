#!/usr/bin/env bash
# Component interop smoke test: option<s32> result canonical ABI is name-independent.
...
COMPONENT_WASM="tests/component-interop/jco/option-renamed/option_renamed.component.wasm"
SOURCE_REL="tests/component-interop/jco/option-renamed/option_renamed.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling option_renamed.ark -> component wasm"
...
run_test "wrap_positive(7) = some(7)" "some(7)" "wrap-positive(7)"
run_test "wrap_positive(0) = none" "none" "wrap-positive(0)"
