#!/usr/bin/env bash
# Component interop smoke test: string parameter/result canonical ABI is name-independent.
...
COMPONENT_WASM="tests/component-interop/jco/string-renamed/string_renamed.component.wasm"
SOURCE_REL="tests/component-interop/jco/string-renamed/string_renamed.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling string_renamed.ark -> component wasm"
"$ARUKELLT" compile \
    --emit component \
