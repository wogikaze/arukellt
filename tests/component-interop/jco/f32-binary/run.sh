#!/usr/bin/env bash
# Component interop smoke test: f32 binary parameter/result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/f32-binary/f32_binary.component.wasm"
SOURCE_REL="tests/component-interop/jco/f32-binary/f32_binary.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling f32_binary.ark -> component wasm"
...
echo "[2/3] Running f32 binary invocation"
run_test "right32(2.5, 3.25) = 3.25" "3.25" "right32(2.5, 3.25)"
