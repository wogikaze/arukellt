#!/usr/bin/env bash
# Component interop smoke test: f32 parameter/result canonical ABI is name-independent.
...
COMPONENT_WASM="tests/component-interop/jco/f32-renamed/f32_renamed.component.wasm"
SOURCE_REL="tests/component-interop/jco/f32-renamed/f32_renamed.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling f32_renamed.ark -> component wasm"
"$ARUKELLT" compile \
    --emit component \
...
echo "[2/3] Running f32 invocation"
run_test "halve32(2.5) = 2.5" "2.5" "halve32(2.5)"
