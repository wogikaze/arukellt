#!/usr/bin/env bash
# Component interop smoke test: String parameter to u32 result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/string-count32/string_count32.component.wasm"
SOURCE_REL="tests/component-interop/jco/string-count32/string_count32.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling string_count32.ark -> component wasm"
"$ARUKELLT" compile \
    --emit component \
...
run_test 'count32_text("") = 32' "32" 'count32-text("")'
run_test 'count32_text("hello") = 123456' "123456" 'count32-text("hello")'
