#!/usr/bin/env bash
# Component interop smoke test: renamed i8 scalar parameter/result.
...
COMPONENT_WASM="tests/component-interop/jco/i8-renamed/i8_renamed.component.wasm"
SOURCE_REL="tests/component-interop/jco/i8-renamed/i8_renamed.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling i8_renamed.ark -> component wasm"
...
echo "[2/3] Running renamed i8 invocations"
run_test "nudge_tiny(7) = 4" "4" "nudge-tiny(7)"
run_test "nudge_tiny(-7) = -10" "-10" "nudge-tiny(-7)"
