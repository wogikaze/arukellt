#!/usr/bin/env bash
# Component interop smoke test: tuple<s32, s32> result canonical ABI.
...
COMPONENT_WASM="tests/component-interop/jco/tuple-swap/tuple_swap.component.wasm"
SOURCE_REL="tests/component-interop/jco/tuple-swap/tuple_swap.ark"
cd "$REPO_ROOT"
...
echo "[1/3] Compiling tuple_swap.ark -> component wasm"
...
run_test "swap(1, 2) = (2, 1)" "(2, 1)" "swap(1, 2)"
