...
pub fn identity(x: i32) -> i32 {
    unsafe {
        ...
        let ret = unsafe { wit_import0(_rt::as_i32(&x)) };
        ret
    }
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:test:roundtrip@0.1.0:guest:encoded world"
)]
#[doc(hidden)]
...
@\x01\x01xz\0z\x03\0\x08identity\x01\0\x01@\0\0z\x04\0\x03run\x01\x01\x04\0\x1at\
est:roundtrip/guest@0.1.0\x04\0\x0b\x0b\x01\0\x05guest\x03\0\0\0G\x09producers\x01\
