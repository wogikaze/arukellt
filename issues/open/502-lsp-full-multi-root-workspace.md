...
**Reopen reason:** Multi-root workspace LSP resolution not implemented in selfhost LSP state.

**Violated acceptance:** Multi-root index, dependency graph walk, cross-package resolution

**Evidence files:**
- `src/compiler/lsp/state_record.ark`
- `tests/package-workspace/ (package fixtures only)`
