...
- [ ] extension package と `.ark` language registration が追跡できる
- [ ] `arukellt lsp` を起動する language client 導線がある
- [ ] binary discovery / settings override / version check の責務が定義されている
