...
- [ ] bootstrap.md の completion criteria が 1 箇所に統合される
- [ ] current-state.md に bootstrap status セクションが追加される
- [ ] 存在しない script への参照が「未作成 (see #325)」として明記される、または #325 完了後に実体化される
- [ ] verify-bootstrap.sh の machine-readable output と docs の記述が一致する
