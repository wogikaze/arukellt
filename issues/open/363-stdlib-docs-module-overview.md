...
- [ ] 主要 module family (core, collections, text, host, io, json) に curated overview セクションが存在する
- [ ] overview に用途概要、推奨 API、target 制約、typical usage pattern が含まれる
- [ ] overview と generated reference の責務が文書化される (overview = curated, reference = exhaustive)
- [ ] legacy landing page が current overview に統合または archive に移動される
