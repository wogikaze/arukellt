...
- [ ] Verification runner output includes the category for failing checks.
- [ ] Failure reports include category, responsible command, and primary path.
- [ ] Existing package-workspace, fixture, component, bootstrap, LSP, and
  extension checks have category labels.
- [ ] Documentation describes the category labels used in failure reports.
