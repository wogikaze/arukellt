...
**Reopen reason:** E0100 unresolved-name diagnostic E2E is skipped in extension tests; CLI/LSP parity not fully verified.

**Violated acceptance:** Diagnostics parity including E0100 regression

**Evidence files:**
- `extensions/arukellt-all-in-one/src/test/extension.test.js (test.skip E0100)`
