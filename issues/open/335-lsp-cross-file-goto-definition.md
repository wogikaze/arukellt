...
**Reopen reason:** Cross-file goto-definition not implemented in selfhost analysis/LSP.

**Violated acceptance:** Qualified-name and cross-file definition resolution

**Evidence files:**
- `src/compiler/analysis/symbols.ark (single-buffer symbol_at only)`
