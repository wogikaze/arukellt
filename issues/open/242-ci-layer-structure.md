...
- [ ] unit / fixture / integration / packaging / editor smoke / determinism の各層が CI として定義されている
- [ ] 各層の目的・対象・合否基準が文書化されている
- [ ] 本線 target の全層が CI で実行されている
- [ ] 各層の失敗が個別に識別できる（どの層で落ちたかが分かる）
