...
**Reopen reason:** Stdlib definition resolution not manifest-driven in selfhost LSP.

**Violated acceptance:** goto_definition/hover resolve stdlib via manifest metadata

**Evidence files:**
- `src/compiler/lsp/completion.ark (hardcoded items)`
- `no manifest loader in LSP path`
