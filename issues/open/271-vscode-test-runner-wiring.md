...
**Reopen reason:** Extension test runner wired locally but CI workflow does not run extension E2E job.

**Violated acceptance:** CI job runs extension tests on every PR

**Evidence files:**
- `.github/workflows/ci.yml (no extension test job)`
