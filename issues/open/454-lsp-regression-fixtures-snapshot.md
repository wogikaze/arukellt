...
**Reopen reason:** Nine LSP snapshot regression tests lived in deleted `crates/ark-lsp`; not ported to selfhost.

**Violated acceptance:** Snapshot regression fixtures and runner for LSP responses

**Evidence files:**
- `absent crates/ark-lsp/tests/`
- `only 2 selfhost lsp fixtures`
