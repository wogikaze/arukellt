...
**Reopen reason:** Acceptance cites `arukellt:build` / `ark build` task execution; repo tests use compile/fmt-check tasks only.

**Violated acceptance:** Task provider E2E for build task name and argv

**Evidence files:**
- `extensions/arukellt-all-in-one/src/test/extension.test.js (#622 suite differs from #273 acceptance text)`
