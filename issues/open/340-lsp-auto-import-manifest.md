...
**Reopen reason:** Auto-import from manifest/project not implemented.

**Violated acceptance:** Code actions / completion insert missing imports from manifest

**Evidence files:**
- `src/compiler/lsp/completion.ark (static list only)`
