...
| 32 | 825 | AST cache format repair (not “re-enable as-is”) | selfhost-infra | 0 | 0 | 1 | 5 | 3 | 9 |
...
| 36 | 696 | 696 — `Debug` trait and `format!` / `write!` equivalent for... | stdlib-api | 0 | 0 | 2 | 3 | 3 | 8 |
