...
2. [x] 現役 ADR の判断文脈で T1–T5 を使っていない（歴史括弧のみ可）— normative/current 伝播込み
...
2026-07-11: ADR 台帳修復 → current-state/research 同期 → ADR/RFC 分割 →
normative/current 伝播（spec/memory-model/release/test/cli、CLI default=`wasm32-gc`、
CoreHIR pipeline、check-docs normative sync、PROPOSED=提案日、ADR-036→plan）。
