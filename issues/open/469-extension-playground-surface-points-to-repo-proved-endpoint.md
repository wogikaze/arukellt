...
- [ ] extension command / config が指す playground endpoint は、issues 466 と 468 の repo proof から辿れる path だけである。
- [ ] README の description は actual repo-proved endpoint behavior と一致する。
- [ ] repo proof がない endpoint を default value や user-visible command で expose しない。
