...
**Reopen reason:** Partial selfhost hover behavior; cited `crates/ark-lsp/tests/lsp_e2e.rs` evidence deleted with #572.

**Violated acceptance:** Semantic-only hover contract with regression tests on selfhost path

**Evidence files:**
- `src/compiler/lsp/feature_hover.ark`
