...
**Reopen reason:** Parent rollup closed on false-done #479; settings behavior claims lack LSP server-side proof.

**Violated acceptance:** Settings change LSP CodeLens/hover/diagnostics/on-save behavior

**Evidence files:**
- `issues/done/479-lsp-config-struct-and-handler-behavior.md`
