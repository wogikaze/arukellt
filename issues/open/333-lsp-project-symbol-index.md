...
**Reopen reason:** Project-wide symbol index absent in selfhost LSP after #572 deleted `crates/ark-lsp`.

**Violated acceptance:** workspace/symbol searches indexed project; did_open/change updates index

**Evidence files:**
- `src/compiler/lsp/* (no index)`
- `issues/done/572-phase7-delete-ark-lsp.md`
