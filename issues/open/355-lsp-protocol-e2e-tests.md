...
**Reopen reason:** LSP protocol E2E coverage is partial (2 script fixtures only); acceptance requires broader protocol/error coverage.

**Violated acceptance:** Protocol error handling and handler coverage beyond lifecycle+hover/def

**Evidence files:**
- `tests/fixtures/selfhost/lsp_*.lsp-script (2 files)`
