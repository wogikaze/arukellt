...
- [ ] `docs/target-contract.md` で T2/T4/T5 の各行に `scaffold / blocked / not-started` が明記されている
- [ ] T2/T4/T5 のそれぞれについて「どこまで実装されているか」「何が必要か」が 1 段落以内で記述されている
- [ ] T2/T4/T5 に関連する既存の scaffold コードがコメントまたは `#[allow(dead_code)]` 等で識別されている
