...
- `scripts/check-docs-consistency.py` が docs の整合性を一部検証している
- spec.md と syntax.md / type-system.md の同期は手動
- spec の stable 機能が変更されてもガイドが更新されない可能性がある

## Acceptance

- [ ] CI が spec.md の stable 機能記述とガイドの記述を比較チェックする
- [ ] 不整合がある場合に CI が warning を出す
- [ ] `scripts/check-docs-consistency.py` に言語 docs 同期チェックが追加される
- [ ] spec の stable 機能変更時にガイド更新の必要性が自動検出される
