...
**Reopen reason:** Definition response span covers declaration block, not identifier-only; no name_span in parser AST.

**Violated acceptance:** gotoDefinition range covers identifier token only

**Evidence files:**
- `tests/fixtures/selfhost/lsp_hover_definition.lsp-expected`
- `src/compiler/lsp/feature_symbol.ark`
