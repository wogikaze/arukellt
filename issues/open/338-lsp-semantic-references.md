...
**Reopen reason:** Semantic references / documentHighlight not implemented.

**Violated acceptance:** textDocument/references with symbol-id semantics

**Evidence files:**
- `src/compiler/lsp/dispatch.ark (no references handler)`
