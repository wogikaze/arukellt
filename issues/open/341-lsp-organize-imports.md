...
**Reopen reason:** Organize imports code action absent.

**Violated acceptance:** source.organizeImports removes unused / sorts imports

**Evidence files:**
- `src/compiler/lsp/dispatch.ark (no codeAction handler)`
