...
**Reopen reason:** Signature help handler and capability missing in selfhost LSP.

**Violated acceptance:** textDocument/signatureHelp for stdlib functions

**Evidence files:**
- `src/compiler/lsp/responses_lifecycle.ark`
- `src/compiler/lsp/dispatch_features.ark`
