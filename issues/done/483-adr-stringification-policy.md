...
1. ADR now has a Non-goals section explicitly scoping out: "method syntax implementation (#484 scope), removal of `i32_to_string`/`i64_to_string` helpers, Display trait / stdlib restructuring, docs/fixture updates (#171)"
2. ADR Status: DECIDED
