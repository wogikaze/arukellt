...
**Reopen reason:** Parser error-node contract (NK_ERROR/NK_MISSING, sync_to_decl_start) not present in modular parser.

**Violated acceptance:** Explicit error AST nodes and sync recovery per acceptance

**Evidence files:**
- `src/compiler/parser/kinds.ark`
- `rg NK_ERROR/NK_MISSING under src/compiler/parser/`
