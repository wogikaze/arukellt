...
- [x] README の冒頭に「今何ができるか」が 5 行以内で明確に書かれている
- [x] 「実験的」「未実装」「設計のみ」な機能が README 上で誤解なく識別できる
- [x] Quickstart セクションが実際に動くコマンドのみで構成されている
- [x] 詳細状態は `docs/current-state.md` へのリンクで案内している
...
Closed 2026-04-09. README header shows what works today (5 lines), links to current-state.md. Generated section shows accurate fixture counts (575/586). All Quickstart commands work.