...
- [x] deprecated API ごとに「旧コード → 新コード」の変換例が文書化される
- [x] 移行ガイドが `docs/stdlib/` に独立文書として存在する
- [x] 削除タイムラインの方針 (N 版後に削除等) が文書化される
- [x] `scripts/gen/generate-docs.py` が deprecated API の reference に移行ガイドへのリンクを挿入する
