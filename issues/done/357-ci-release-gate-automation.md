...
- [x] release-checklist の extension 検証項目のうち自動化可能なものが CI job に移行される
- [x] LSP protocol compliance が CI で検証される (#355 前提)
- [x] formatter / CLI / LSP の出力一致が CI で検証される (#356 前提)
- [x] `docs/release-checklist.md` が更新され、残る手動項目が明示される
