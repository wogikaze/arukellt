...
**Reopen reason:** Hover returns AST signature text, not type-inferred hover with stdlib docs.

**Violated acceptance:** Type-inferred hover and stdlib documentation in hover payload

**Evidence files:**
- `src/compiler/lsp/feature_hover.ark`
- `src/compiler/analysis/symbols.ark`
