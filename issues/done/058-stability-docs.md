...
3. `docs/cookbook/`: "5 つ以上のレシピを作成 (JSON 処理、CLI ツール、ファイル処理、Wasm binary、テスト)"
4. `tests/fixtures/examples/`: 各 Stable API の example fixture を作成
5. ラベル付与は保守的に: 迷ったら Experimental にする
