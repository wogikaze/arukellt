...
**Reopen reason:** LSP performance smoke tests and `tests/fixtures/lsp_perf/` absent after #572.

**Violated acceptance:** Performance smoke tests with baseline recording

**Evidence files:**
- `no lsp_perf fixtures`
- `no lsp_perf.rs equivalent`
