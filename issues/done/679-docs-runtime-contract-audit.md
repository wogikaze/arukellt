...
- [x] 監査レポート `docs/history/reports/docs-runtime-contract-audit-2026-06-17.md`（または同等）に
...
|-------------|----------------|
| Audit report | `docs/history/reports/docs-runtime-contract-audit-2026-06-17.md` |
