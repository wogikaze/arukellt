...
**Reopen reason:** Context-aware completion absent; flat static completion list only.

**Violated acceptance:** Dot/pattern/type/use-context completion

**Evidence files:**
- `src/compiler/lsp/completion.ark`
