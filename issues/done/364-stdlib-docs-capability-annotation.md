...
- [x] `scripts/generate-docs.py` が manifest の target/kind から注記を自動生成する

## Resolution

- Updated `scripts/generate-docs.py` to show target constraints and ⚠️ warning for host_stub APIs
