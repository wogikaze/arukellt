...
| Built from commit | `12ea153d` — #41: adds clock_time_get/random_get WASI imports, time/random intrinsic dispatch handlers, and SCRATCH_CLOCK_RESULT scratch constant
