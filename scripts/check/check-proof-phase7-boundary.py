...
EXPECTED_FILES = {
    ...
    "scripts/gen/convert-typed-corehir-v7.py",
    "src/compiler/driver/proof_type_registry.ark",
    "src/compiler/driver/pipeline_backend.ark",
    "scripts/proof/proof_type_registry.py",
    "scripts/check/check-proof-type-registry-emission.py",
    "tests/verified-core/proof_type_registry_vec.ark",
    ...
    "scripts/gen/write-smt-vcs-v7.py",
    "scripts/gen/prepare-proof-release-toolchain-v7.py",
    "scripts/tests/test_proof_phase7_readonly_memory.py",
    "scripts/tests/test_typed_corehir_v3_machine_memory.py",
    "scripts/tests/test_proof_release_toolchain_v7.py",
...
EXPECTED_CHECKS = {
    ...
    "compiler-TypeInfo-structural-reference-registry",
    "compiler-Vec-element-TypeId-from-type-args",
    "compiler-reference-display-name-independence",
    "canonical-v7-converter-entrypoint",
    "phase7-smt-entrypoint",
    "release-toolchain-translator-binding",
...
EXPECTED_SCALARS = {
    ...
    "reference_identity": "TypeInfo-tag-type-args-v1",
