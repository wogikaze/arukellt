"""wasm32-gc: Vec<JsonValue> get_unchecked dests must validate as open-enum refs."""
...
FIXTURE = "tests/fixtures/stdlib_json/json_pretty_array.ark"


class Wasm32GcJsonPrettyValidateTests(unittest.TestCase):
    def test_json_pretty_array_compiles_and_validates(self):
        ...
        output = ROOT / ".build/tests/json_pretty_array_gc.wasm"
