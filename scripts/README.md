...
| Script | Language | Purpose | Usage |
|--------|----------|---------|-------|
| `gen-harness-report.py` | Python | Parse fixture harness output for CI artifact upload | `python3 scripts/gen/gen-harness-report.py [--baseline FILE] [--text] [LOG_FILE]` |
