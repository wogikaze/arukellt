...
(module
  ...
  (type $stream (func (param i32 i32 i32) (result i32)))
  ...
  (func (export "read-via-stream") (type $stream) (param i32 i32 i32) (result i32) (i32.const 0))
  (func (export "write-via-stream") (type $stream) (param i32 i32 i32) (result i32) (i32.const 0))
