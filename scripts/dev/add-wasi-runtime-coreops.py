...
subprocess.run([wrapper, "fmt", "std/host/fs.ark"], cwd=root, env=env, check=True, timeout=420)
subprocess.run([wrapper, "fmt", "std/host/fs.ark", "--check"], cwd=root, env=env, check=True, timeout=420)
