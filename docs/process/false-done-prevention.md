...
> 監査ログ: `docs/history/reports/false-done-audit-2026-06-12.md`  
> 更新: 2026-06-12
...
### 既知 reopen 群と必要な close-gate 証拠（2026-06-12 監査後）

監査で **68 issue** を reopen。全件の再-close 前に close-gate fixture 必須。優先レーン:

| Lane | Issues | 必要な close-gate 証拠 |
|------|--------|------------------------|
| P2 native | #074, #510, #118 | P2 stdio + `wasi:cli/run` export + `wasm-tools validate` + wasmtime run（bootstrap 非依存） |
| Playground | #472, #500, #491 | typecheck が parse と区別できる worker/fixture；CI perf gate が workflow に存在 |
| Host / stdlib | #051, #137, #138, #292–#295, #358, #445, #446, #447 | `__intrinsic_*` dispatch + manifest honesty；`stdlib_time/monotonic.ark` run |
| Manifest honesty | #633 | `std/manifest.toml` / docs が未実装 host を宣伝しない |
| WIT / component | #034, #073, #117, #618, #443 | callable import / syscall matrix / WIT quality / round-trip / compose |
| LSP / IDE | #628, #634, #333–#342, #439, #441, #502 | stdio transport + lifecycle gates + 各 feature の script/E2E fixture |
| Extension / CLI | #183–#184, #191, #216–#219, #236, #271, #273, #440, #456, #464, #480 | 各 acceptance に対応する extension test または CLI fixture |
| Wasm / MIR opt | #064, #067, #070, #080, #082, #083, #115 | 該当 emitter/opt pass の manifest fixture |
| Hygiene | #418, #422 | `check-orphan-inventory.sh` / admission gate が verify に登録 |
| Import syntax | #123 | Layer C 実装（docs 以外）の module/fixture |

完全な reopen 一覧: `docs/history/reports/false-done-audit-2026-06-12.md` §1 reopen count by slice。
