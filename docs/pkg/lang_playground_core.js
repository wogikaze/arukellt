/* @ts-self-types="./lang_playground_core.d.ts" */
 ...
 * @returns {string}
 */
export function run_source(source, _function, args_json, step) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ret = wasm.run_source(ptr0, len0, ptr1, len1, ptr2, len2, step);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lang_playground_core_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lang_playground_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
