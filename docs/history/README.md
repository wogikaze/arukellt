...
| [stdlib/std.md](stdlib/std.md) | Arukellt 標準ライブラリ総合設計書 | Archive | Historical design rationale (March 2026). This v3-era proposal contains legacy target and lifecycle terminology. It is not the current API contract; use reference.md, stability-policy.md, and ../current-state.md. |
