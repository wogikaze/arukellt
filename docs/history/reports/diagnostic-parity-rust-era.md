> **ARCHIVED REPORT** — Rust-vs-selfhost diagnostic comparison (Rust CLI retired). Current gate: `python3 scripts/manager.py selfhost diag-parity`. See `docs/compiler/bootstrap.md`.
...
- [Error Codes Reference](../../compiler/error-codes.md)
- [Diagnostic System Design](../../compiler/diagnostics.md)
- [Bootstrap Guide](../../compiler/bootstrap.md)
