...
| 5 | `current-state.md` ↔ `capability-surface.md` (host reachability) | **gap** | Historical audit: `std::host::http|sockets|udp` were **not user-reachable** while `src/compiler/wasm/call_host.ark` dispatched `call_host_network.ark`; ADR-054 subsequently deleted that surface | [#675](../../../issues/done/675-host-capability-reachability-flags.md), [#681](../../../issues/open/681-stdlib-manifest-reachability-audit.md) |
...
| G-679-04 | Host http/sockets/udp reachability docs vs runtime | [#675](../../../issues/done/675-host-capability-reachability-flags.md) | implementation |
