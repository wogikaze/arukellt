...
以前の LLM readiness plan は、

- diagnostics / cookbook / quickstart / unified spec を作るための計画
- capability I/O や古い v0 制約を前提にした TODO
- まだ未完だった時期の段取り

を記録したものでした。

現在は多くの成果物が既に存在し、残っているものも「計画」より「archive」として扱う方が自然です。
