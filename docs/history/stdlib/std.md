...
> **Historical design rationale (March 2026).** This v3-era proposal contains legacy target and lifecycle terminology. It is not the current API contract; use [`../../stdlib/reference.md`](../../stdlib/reference.md), [`../../stdlib/stability-policy.md`](../../stdlib/stability-policy.md), and [`../../current-state.md`](../../current-state.md).
