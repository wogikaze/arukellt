# RFC-002: Semantic Type Spine（詳細設計）

ステータス: 仕様草案（ADR-040 が採択した中核判断の詳細）  
関連 ADR: [ADR-040](../adr/ADR-040-typed-mir-signature-registry.md)  
関連 plan: [typed-mir-signature-registry.md](../plans/typed-mir-signature-registry.md)  
日付: 2026-07-03（ADR 採択） / 抽出: 2026-07-11

本 RFC は TypeId / MirValueType / SignatureRegistry / MonoInstanceTable 等の
**構造体定義・不変条件・効果**の正本である。採択判断は ADR-040。実装フェーズは plan。
