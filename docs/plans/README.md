...
| [675-host-capability-reachability-flags.md](675-host-capability-reachability-flags.md) | \#675 — Host capability user-reachability and runtime permission flags 実装計画 | Archive | Superseded (2026-09-12): ADR-054 retires host-linker, the Rust host runtime, and the old HTTP/TCP/UDP/stream surfaces. This document remains a historical plan; its host-linker phases and Cargo verification commands are |
...
| [727-host-bridge-retirement.md](727-host-bridge-retirement.md) | #727 — Retire arukellt_host custom host bridge クローズ計画 | Archive | Superseded (2026-09-12): The bridged implementation described here is retired by ADR-054. The repository now deletes the network APIs and runs standard WASI P2 components through wasm-tools; do not restore the |
| [807-fixture-parity-remaining-failures.md](807-fixture-parity-remaining-failures.md) | #807 — Fixture parity: 367 remaining failures クローズ計画 | Archive | Superseded historical record (2026-09-12): The execution notes below predate ADR-054 and mention the retired host-linker. They are retained as evidence of the old parity work, not as current verification instructions. |
...
| [arukellt-host-bridge-retirement.md](arukellt-host-bridge-retirement.md) | #727 — arukellt_host bridge retirement 実装計画 | Archive | Superseded (2026-09-12): This bridged plan is historical. ADR-054 completes the retirement by deleting host-linker, the old network API surfaces, and compatibility paths; official WASI P2 component packaging is |
...
| [native-cpp-experimental-promotion.md](native-cpp-experimental-promotion.md) | native-cpp selfhost executor experimental 昇格計画 | Archive | Owner: native-cpp / umbrella #848 / root-liveness #847 Created: 2026-07-23 Last updated: 2026-07-23 Phase 0 baseline: .build-native-recovery/selfhost/native/baselines/20260723-221402/ |
...
| [selfhost-compiler-core-rewrite.md](selfhost-compiler-core-rewrite.md) | セルフホストコンパイラ中核再構築 | Archive | Owner: overlay / #851 / ADR-053 Created: 2026-09-01 Last updated: 2026-09-16 |
