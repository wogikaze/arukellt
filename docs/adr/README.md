...
| [ADR-034-component-composition-linking.md](ADR-034-component-composition-linking.md) | ADR-034: Component Composition Linking Model | Archive | ステータス: PROPOSED — Phase 1 scaffold landed (#443); native linker deferred |
