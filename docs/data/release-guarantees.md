...
| `fixture_harness` | `guaranteed` | `every-pr` | Fixture harness passes for the current observed harness snapshot | `tests/fixtures/manifest.txt`, `registered-harness-cases` | ❌ fail | 🟢 fresh | fixture-set | `222faab5` | See fixture accounting: observed harness ≠ full manifest expansion |
...
| `emit_component` | `provisional` | `nightly` | compile --emit component / component build | `component-emit`, `wasm32-gc` | ❌ fail | 🟢 fresh | fixture-set, smoke | `222faab5`, `a80b4181` | Library exports need s2 wasm; ABI coverage incomplete; may use wasm-tools helpers |
...
| `check_fixture_harness` | `fixture_harness` | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `fixture-set` | 367 | `incident_fixture_parity_367` | `222faab5` | `python3 scripts/manager.py verify fixtures` |
...
| `check_t3_wasm_validate` | — | 🔴 yes | — | ✓ | ❌ fail | 🟢 fresh | `smoke` | 1 | `incident_t3_wasm_validate` | `222faab5` | `python3 scripts/check/check-t3-wasm-validate.py` |
| `check_selfhost_fixpoint` | — | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `exhaustive` | 1 | `incident_selfhost_fixpoint` | `222faab5` | `python3 scripts/manager.py selfhost fixpoint --build` |
| `check_selfhost_cli_parity` | — | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `smoke` | 2 | `incident_selfhost_cli_parity` | `222faab5` | `python3 scripts/manager.py selfhost parity --mode --cli` |
| `check_selfhost_diag_parity` | — | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `smoke` | 3 | `incident_selfhost_diag_parity` | `222faab5` | `python3 scripts/manager.py selfhost diag-parity` |
| `check_wat_roundtrip` | — | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `smoke` | 1 | `incident_wat_roundtrip` | `222faab5` | `bash scripts/run/wat-roundtrip.sh` |
| `check_component_interop_wasmtime` | `emit_component` | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `fixture-set` | 103 | `incident_component_interop_103` | `222faab5` | `python3 scripts/manager.py verify component-interop` |
