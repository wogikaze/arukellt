...
| `fixture_harness` | `guaranteed` | `every-pr` | Fixture harness passes for the current observed harness snapshot | `tests/fixtures/manifest.txt`, `registered-harness-cases` | ❌ fail | 🟢 fresh | fixture-set | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | See fixture accounting: observed harness ≠ full manifest expansion |
...
| `emit_component` | `provisional` | `nightly` | compile --emit component / component build | `component-emit`, `wasm32-gc` | ❌ fail | 🟢 fresh | fixture-set, smoke | `52967b17ace3f63cc2fe59ac9bbf5f0202445106`, `a80b4181` | Library exports need s2 wasm; ABI coverage incomplete; may use wasm-tools helpers |
...
| `check_fixture_harness` | `fixture_harness` | 🔴 yes | ✓ | — | ❌ fail | 🟢 fresh | `fixture-set` | 367 | `incident_fixture_parity_367` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `python3 scripts/manager.py verify fixtures` |
