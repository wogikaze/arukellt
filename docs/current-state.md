...
- Fixture registry: 2770 manifest entries (distinct unit from harness outcomes)
- Not in last harness snapshot: 1182 registry entries (not proof they fail)
- Accounting note: 57+1089+442=1588 outcomes from the 2026-07-15 selfhost fixture-parity run at 982f3102; 2770 is tests/fixtures/manifest.txt registry size. The 1182 remainder were not part of that run (not proof they fail).
