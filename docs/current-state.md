...
- Accounting note: 804+367+417=1588 outcomes from the 2026-07-14 selfhost fixture-parity run; 2693 is tests/fixtures/manifest.txt registry size. The 1105 remainder were not part of that run (not proof they fail).
- Wasm validation is a hard error (W0004)
- Verification entry point: `python3 scripts/manager.py verify quick` — **164/165 checks pass**
...
|----|-------|----------|---------:|----------|-----------------|---------|-------|-------|------------|---------------|-----------|
| `check_fixture_harness` | `full` | `fixture` | 367 | `incident_fixture_parity_367` | Failures in observed harness snapshot. Same incident as selfhost fixture-parity — not double-counted. See project-state.toml for current registry count. | `python3 scripts/manager.py verify fixtures` | compiler/runtime | #807 | `89eb5eb4` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
| `check_t3_wasm_validate` | `quick` | `verification` | 1 | `incident_t3_wasm_validate` | T3 fixture Wasm validation fails for 192 run fixtures (func N failed to validate) | `python3 scripts/check/check-t3-wasm-validate.py` | Wasm backend | #808 | `fd14539c23288d3ed993c03600aeed36cd478d06` | `fd14539c23288d3ed993c03600aeed36cd478d06` | `fresh` |
| `check_selfhost_fixpoint` | `full` | `bootstrap` | 1 | `incident_selfhost_fixpoint` | Stage 2 and Stage 3 compiler hashes differ; fixpoint not reached | `python3 scripts/manager.py selfhost fixpoint --build` | selfhost compiler | #813 | `a80b4181` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
| `check_selfhost_cli_parity` | `full` | `bootstrap` | 3 | `incident_selfhost_cli_parity` | CLI parity drifts for --help, lint, and compose --validate | `python3 scripts/manager.py selfhost parity --mode --cli` | selfhost CLI | #811 | `a80b4181` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
| `check_selfhost_diag_parity` | `full` | `bootstrap` | 1 | `incident_selfhost_diag_parity` | Selfhost diagnostic parity differs from Rust host compiler | `python3 scripts/manager.py selfhost diag-parity` | selfhost diagnostics | #812 | `a80b4181` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
| `check_wat_roundtrip` | `full` | `target-contract` | 1 | `incident_wat_roundtrip` | The wasm2wat/wat2wasm roundtrip gate fails | `bash scripts/run/wat-roundtrip.sh` | Wasm backend | #809 | `a80b4181` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
| `check_component_interop_wasmtime` | `full` | `component-interop` | 103 | `incident_component_interop_103` | All wasmtime component-interop cases fail. Dedicated command (not aggregate verify full). | `python3 scripts/manager.py verify component-interop` | component model | #810 | `a80b4181` | `52967b17ace3f63cc2fe59ac9bbf5f0202445106` | `fresh` |
