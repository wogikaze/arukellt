...
|------|-------|-------|---------|
| [826-symbol-path-intern-clone-audit.md](826-symbol-path-intern-clone-audit.md) | #826 — Symbol / path interning + hot-path clone audit | Archive | 計画対象ファイルの clone( 出現数（2026-07-26 worktree）: |
| [834-wasm32-gc-bootstrap-probe.md](834-wasm32-gc-bootstrap-probe.md) | #834 Probe: wasm32-gc self-emit on 23GiB host (2026-07-26) | Archive | Historical evidence: The host-linker phase below was superseded by ADR-054 on 2026-09-12. Current selfhost execution uses direct Wasmtime and official WASI P2 component packaging; the old host-linker commands are not |
...
| [p2-bridged-wasi-path-roadmap.md](p2-bridged-wasi-path-roadmap.md) | P2 Bridged WASI Path — 今後の調査・修正項目 | Archive | Superseded (2026-09-12): This roadmap documents the retired in-tree bridge/stub approach. ADR-054 replaces it with official WASI P2 WIT and wasm-tools component embed/new; none of the bridge implementation steps |
| [selfhost-compile-latency-root-cause.md](selfhost-compile-latency-root-cause.md) | Selfhost compile latency — root cause (2026-07-17, revised 2026-07-20) | Archive | decl_emit が total の 35% かつ第 2 位の 1.5 倍を満たさず（L5: 11.1%; #829 after: 17.9%）。 receipt: receipts/824-early-body-decl-emit-defer-receipt.json |
