...
| `wasm30/04-multiple-memories.wat` | `42` | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ `WASM module load failed: multiple memories` | ✅ | — | — | — |
...
| `experimental/legacy-eh-try-catch.wat` | `42` | ❌ `error: 'catch' found outside 'LegacyTry' block (at offset 0x` | ❌ `skipped (parse failed)` | ❌ `/home/wogikaze/arukellt/docs/research/wat-probes/experimenta` | ❌ `skipped (parse failed)` | ❌ `no binary` | ❌ `no binary` | ❌ `no binary` | — | — | — |
