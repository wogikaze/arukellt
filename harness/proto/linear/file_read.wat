;; Case 6: WASI file read (linear). Reads into linear buffer, prints nread. Expected: 1024
;; Run: wasmtime run --dir <testdata>/ file_read.wasm
(module
  ...
  (func (export "_start")
    ...
    (call $print_i32 (i32.load (i32.const 16))))
)
